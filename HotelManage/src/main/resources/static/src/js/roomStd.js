var roomStd = {
    ...
    funcs: {
        renderTable: function () {
            ...
            var addBtn = $("#add")
            roomStd.funcs.bindAddEventListener(addBtn) //追加增加事件
            ...
            addBtn.on('click', function () {
                ...
                layer.open({
                    ...
                    content: "<div id='addModal'>" +
                        ...
                        "<p style='padding: 5px 0px 5px 0px;'>标准名称:<input type='text' id='name'/></p>" +
                        "<p style='padding: 5px 0px 5px 0px;'>客房面积:<input type='text' id='area'/></p>" +
                        "<p style='padding: 5px 0px 5px 0px;'>床位数量:<input type='text' id='bedno'/></p>" +
                        "<p style='padding: 5px 0px 5px 0px;'>&nbsp;&nbsp;&nbsp;&nbsp;设备1:<input type='text' id='equip1'/></p>" +
                        "<p style='padding: 5px 0px 5px 0px;'>&nbsp;&nbsp;&nbsp;&nbsp;设备2:<input type='text' id='equip2'/></p>" +
                        "</div>" +
                        "</div>",
                    area: ['350px', '260px'],
                    btn: ['确认', '取消'],
        ...
        bindDeleteEventListener: function (deleteBtns) {
            ...
            deleteBtns.on('click', function () {
                ...
                layer.open({
                    ...
                    offset: ['40%', '55%'],
                    yes: function (index) {
                        var stdno = _this.attr('id').substr(7)
                        $.post(home.urls.roomStd.delete, {
                            stdno: stdno
                        }, function (result) {
                            layer.msg(result.msg, {
                                offset: ['40%', '55%'],
        ...
        renderHandler: function ($tbody, data) {
            ...
            data.forEach(function (e) {
                ...
                $tbody.append(
                    ...
                    "<td>" + (e.equip1) + "</td>" +
                    "<td>" + (e.equip2) + "</td>" +
                    "<td><a href='#' class='deletes' id='delete-" + e.stdno + "'><i class=\"layui-icon layui-icon-delete\"></i></a></td>" +
                    "</tr>")
            }) //$数据渲染完毕
            // var editBtns = $('.editequipment')
            var deleteBtns = $('.deletes')
            roomStd.funcs.bindDeleteEventListener(deleteBtns)
